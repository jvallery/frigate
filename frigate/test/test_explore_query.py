    ...
    def __init__(self, database: CountingDatabase) -> None:
        ...
        for name in explore_query.EXPLORE_EVENT_FIELDS:
            ...
            if name in json_fields:
                converter = lambda value: json.loads(value)
...
class ExploreQueryTest(unittest.TestCase):
    ...
    def test_two_queries_preserve_authorization_counts_limit_and_projection(self) -> None:
        ...
        self.assertEqual(
            {"score", "description", "path_data"}, set(events[0]["data"])
        )
    ...
    def test_zero_and_empty_authorization_do_not_query(self) -> None:
        self.assertEqual([], explore_query.query_explore_events(self.event_model, [], 10))
        self.assertEqual(
