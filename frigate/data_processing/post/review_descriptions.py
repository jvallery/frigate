...
class ReviewDescriptionProcessor(PostProcessorApi):
    ...
    def submit_recovery(
        ...
        try:
            ...
            start_time = (
                review.start_time.timestamp()
                if hasattr(review.start_time, "timestamp")
                else float(review.start_time)
            )
            end_time = (
                review.end_time.timestamp()
                if hasattr(review.end_time, "timestamp")
                else float(review.end_time)
            )
